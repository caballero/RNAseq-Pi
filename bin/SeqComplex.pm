...
Methods:
    ...
    at   - Calculate AT content
    gcs  - Calculate GC skew
    ats  - Calculate AT skew
    cpg  - Calculate CpG content
    cwf  - Calculate Wootton-Federhen complexity
    ce   - Calculate complexity (entropy of the symbols)
    ct   - Calculate Trifonov's complexity
    cl   - Calculate linguistic complexity
    cm   - Calculate Markov model of kth-order complexity
    cz   - Calculate compression (Zlib) as complexity
...
=head1 EXPORT_OK
  ...
  :methods = [gc at gcs ats cpg cwf ce cz ct cl cm]
  :utils   = [log_k pot createWords countWords randSeq]
  :all     = @methods and @utils
